...
for (numAlternatives,numOrigins) in [(30,100),(60,200),(90,300),(120,400)]:
    ...
    for instance in range(numInstances):
        ...
        print('### solve opt_unconstrained_removeRedundant_pnr_origin%s_I%s_J%s_p%s_inst%s.csv'%(numOrigins,numOrigins*numDestins,numAlternatives,numHubs,instance))
...
# =============================================================================
        ...
        optSolution.to_csv(r'opt_unconstrained_removeRedundant_pnr_origin%s_I%s_J%s_p%s_inst%s.csv'%(numOrigins,numOrigins*numDestins,numAlternatives,numHubs,instance), index = False)#Check
...
#         accurateArray += [accurate]    
#         constrainedArray += [constrainedVal]
...
#         ilpTable.to_csv(r'ilpTable_unconstrained_removeRedundant_pnr_origin%s_I%s_J%s_p%s.csv'%(numOrigins,numOrigins*numDestins,numAlternatives,numHubs), index = False)#Check
# =============================================================================
