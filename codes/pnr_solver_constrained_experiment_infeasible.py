...
for (numAlternatives,numOrigins) in [(30,100),(60,200),(90,300),(120,400)]:
    ...
    for instance in range(numInstances):
        ...
        print('### solve opt_constrained_infeasible_pnr_origin%s_I%s_J%s_p%s_inst%s.csv'%(numOrigins,numOrigins*numDestins,numAlternatives,numHubs,instance))
        ...
        optSolution.to_csv(r'opt_constrained_infeasible_pnr_origin%s_I%s_J%s_p%s_inst%s.csv'%(numOrigins,numOrigins*numDestins,numAlternatives,numHubs,instance), index = False)#Check
        ...
        ilpTable.to_csv(r'ilpTable_constrained_infeasible_pnr_origin%s_I%s_J%s_p%s.csv'%(numOrigins,numOrigins*numDestins,numAlternatives,numHubs), index = False)#Check
