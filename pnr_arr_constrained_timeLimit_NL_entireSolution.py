...
for rep in [0,1,2,3]:
    ...
    for numHubs in [40,20]:
        ...
        reset = False
        print()
        print('START arr_constrained_pnr_origin%s_I%s_J%s_p%s_rep%s_lambda%spercent.csv'%(numOrigins,numOrigins*numDestins,numAlternatives,numHubs,rep,int(lambdaNL * 100)))
        print(datetime.datetime.now())
        print('trial=',trial)
        toc = time.time()
        ...
        bestSolution.to_csv(r'arr_constrained_pnr_origin%s_I%s_J%s_p%s_rep%s_lambda%spercent.csv'%(numOrigins,numOrigins*numDestins,numAlternatives,numHubs,rep,int(lambdaNL * 100)), index = False)#Check
        ...
        print()
        print('FINISH arr_constrained_pnr_origin%s_I%s_J%s_p%s_rep%s_lambda%spercent.csv'%(numOrigins,numOrigins*numDestins,numAlternatives,numHubs,rep,int(lambdaNL * 100)))
        print('trial=',trial)
        toc=time.time()
        print('elapse time=',toc-tic)
        print(datetime.datetime.now())
